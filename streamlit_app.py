...
st.markdown("<h1 style='text-align: center; color: black;'>Spray Detector</h1>", 
            unsafe_allow_html=True)
st.header(" ")
st.header(" ")
...
## Load the model
##--------------------------------
if selected_ml_model == "modelSD1":
    reloaded_model = tf.keras.models.load_model("./tf_models/modelSD1")
if selected_ml_model == "modelSD3vgg7M":
    reloaded_model = tf.keras.models.load_model("./tf_models/modelSD3vgg7M")
...
results_options = ['No spray sound detected.',
                    'Spraying signature is DETECTED.']
